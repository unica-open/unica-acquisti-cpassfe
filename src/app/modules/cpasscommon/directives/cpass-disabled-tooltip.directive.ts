...
@Directive({
  selector: '[cpassDisabledTt]'
})
export class CpassDisabledTooltipDirective extends NgbTooltip implements OnInit {

  @Input() cpassDisabledTt: string;
  ...
  @HostListener('mouseenter') onMouseEnter() {
    const text = this.cpassDisabledTt;
