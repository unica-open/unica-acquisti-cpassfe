...
*/
import { Component, OnInit, Directive, TemplateRef, Input, Output, ViewChildren, QueryList,
  EventEmitter, ContentChild } from '@angular/core';
import { SortableDirective } from 'src/app/modules/cpasscommon/directives/sortable.directive';
...
@Component({
  selector: 'cpass-paginated-table',
...
export class PaginatedTableComponent<T> implements OnInit {
  ...
  get paginationFooter(): string {
    ...
    return this.translateService.instant('PAGINATION.INFO', {first, last, total: this.pagedResponse.totalElements});
  }
